...
- No automated test asserts that an atlas the probe updater wrote is addressed the way probe_lighting reads it; the junction is only checked by looking at the gi sample's indirect debug view.
