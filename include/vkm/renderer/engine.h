...
namespace vkm
{
    ...
    */
    ...
    struct VkmEngineLaunchOptions
    {
        ...
        // Create the back buffer so it can be read back, which is what the F2 clipboard capture
    ...
    */
    ...
    private:
        ...
        */
        ...
        // Set by the F2 hotkey, consumed by render() on the next primary-window frame.
