...
namespace
{
    struct MetalRasterStateFixture
    {
        std::unique_ptr<vkm::VkmDriverMetal> driver;
        vkm::VkmInitResult initResult;

        MetalRasterStateFixture()
        {
...
TEST_CASE("Metal raster state - wireframe fill mode draws an outline, not a solid triangle")
{
    MetalRasterStateFixture f;
